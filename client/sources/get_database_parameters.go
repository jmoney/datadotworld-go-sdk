...
// WithOwner adds the owner to the get database params
func (o *GetDatabaseParams) WithOwner(owner string) *GetDatabaseParams {
	o.SetOwner(owner)
	return o
}

// SetOwner adds the owner to the get database params
func (o *GetDatabaseParams) SetOwner(owner string) {
	o.Owner = owner
}

// WithSourceid adds the sourceid to the get database params
func (o *GetDatabaseParams) WithSourceid(sourceid string) *GetDatabaseParams {
	o.SetSourceid(sourceid)
	return o
}

// SetSourceid adds the sourceid to the get database params
func (o *GetDatabaseParams) SetSourceid(sourceid string) {
	o.Sourceid = sourceid
}
