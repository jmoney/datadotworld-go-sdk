...
// WithID adds the id to the get query params
func (o *GetQueryParams) WithID(id string) *GetQueryParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get query params
func (o *GetQueryParams) SetID(id string) {
	o.ID = id
}
