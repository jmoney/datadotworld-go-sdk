...
// WithOwner adds the owner to the download file params
func (o *DownloadFileParams) WithOwner(owner string) *DownloadFileParams {
	o.SetOwner(owner)
	return o
}

// SetOwner adds the owner to the download file params
func (o *DownloadFileParams) SetOwner(owner string) {
	o.Owner = owner
}
