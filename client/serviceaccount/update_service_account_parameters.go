...
type UpdateServiceAccountParams struct {
	...
	// Body.
	Body *models.ServiceAccountUpdateDto
...
func (o *UpdateServiceAccountParams) WithBody(body *models.ServiceAccountUpdateDto) *UpdateServiceAccountParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update service account params
func (o *UpdateServiceAccountParams) SetBody(body *models.ServiceAccountUpdateDto) {
	o.Body = body
}
...
// WithServiceAccount adds the serviceAccount to the update service account params
func (o *UpdateServiceAccountParams) WithServiceAccount(serviceAccount string) *UpdateServiceAccountParams {
	o.SetServiceAccount(serviceAccount)
	return o
}

// SetServiceAccount adds the serviceAccount to the update service account params
func (o *UpdateServiceAccountParams) SetServiceAccount(serviceAccount string) {
