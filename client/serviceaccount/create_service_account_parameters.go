...
type CreateServiceAccountParams struct {
	...
	// Body.
	Body *models.ServiceAccountCreateRequestDto
...
func (o *CreateServiceAccountParams) WithBody(body *models.ServiceAccountCreateRequestDto) *CreateServiceAccountParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create service account params
func (o *CreateServiceAccountParams) SetBody(body *models.ServiceAccountCreateRequestDto) {
	o.Body = body
}
