...
type CreateDatasetParams struct {
	...
	// Body.
	Body *models.DatasetCreateRequest
...
func (o *CreateDatasetParams) WithBody(body *models.DatasetCreateRequest) *CreateDatasetParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the create dataset params
func (o *CreateDatasetParams) SetBody(body *models.DatasetCreateRequest) {
	o.Body = body
}

// WithOwner adds the owner to the create dataset params
func (o *CreateDatasetParams) WithOwner(owner string) *CreateDatasetParams {
	o.SetOwner(owner)
	return o
}

// SetOwner adds the owner to the create dataset params
func (o *CreateDatasetParams) SetOwner(owner string) {
	o.Owner = owner
}
