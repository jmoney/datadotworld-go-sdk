...
// WithID adds the id to the delete dataset params
func (o *DeleteDatasetParams) WithID(id string) *DeleteDatasetParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the delete dataset params
func (o *DeleteDatasetParams) SetID(id string) {
	o.ID = id
}

// WithOwner adds the owner to the delete dataset params
func (o *DeleteDatasetParams) WithOwner(owner string) *DeleteDatasetParams {
	o.SetOwner(owner)
	return o
}

// SetOwner adds the owner to the delete dataset params
func (o *DeleteDatasetParams) SetOwner(owner string) {
	o.Owner = owner
}
