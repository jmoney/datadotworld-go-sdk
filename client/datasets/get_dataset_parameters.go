...
// WithID adds the id to the get dataset params
func (o *GetDatasetParams) WithID(id string) *GetDatasetParams {
	o.SetID(id)
	return o
}

// SetID adds the id to the get dataset params
func (o *GetDatasetParams) SetID(id string) {
	o.ID = id
}

// WithOwner adds the owner to the get dataset params
func (o *GetDatasetParams) WithOwner(owner string) *GetDatasetParams {
	o.SetOwner(owner)
	return o
}

// SetOwner adds the owner to the get dataset params
func (o *GetDatasetParams) SetOwner(owner string) {
	o.Owner = owner
}
