...
// CatalogTableSuggestRequest catalog table suggest request
//
// swagger:model CatalogTableSuggestRequest
type CatalogTableSuggestRequest struct {
...
// Validate validates this catalog table suggest request
func (m *CatalogTableSuggestRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CatalogTableSuggestRequest) validateDescription(formats strfmt.Registry) error {
...
func (m *CatalogTableSuggestRequest) validateMessage(formats strfmt.Registry) error {
...
func (m *CatalogTableSuggestRequest) validateProperties(formats strfmt.Registry) error {
...
func (m *CatalogTableSuggestRequest) validateTitle(formats strfmt.Registry) error {
...
// ContextValidate validate this catalog table suggest request based on the context it is used
func (m *CatalogTableSuggestRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CatalogTableSuggestRequest) contextValidateProperties(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CatalogTableSuggestRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CatalogTableSuggestRequest) UnmarshalBinary(b []byte) error {
	var res CatalogTableSuggestRequest
