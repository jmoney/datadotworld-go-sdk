...
// CatalogGlossarySuggestRequest catalog glossary suggest request
//
// swagger:model CatalogGlossarySuggestRequest
type CatalogGlossarySuggestRequest struct {
	...
	// Example: Aid Option
	CollectionsToAdd []string `json:"collectionsToAdd"`

	// Catalog Collection to which this metadata resource is added. Required for POST and PUT.Available catalog collection can be discovered via appropriate discovery endpoints.
	// Example: Aid Option
	CollectionsToRemove []string `json:"collectionsToRemove"`
...
// Validate validates this catalog glossary suggest request
func (m *CatalogGlossarySuggestRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CatalogGlossarySuggestRequest) validateDescription(formats strfmt.Registry) error {
...
func (m *CatalogGlossarySuggestRequest) validateMessage(formats strfmt.Registry) error {
	...
	if err := validate.MaxLength("message", "body", m.Message, 250); err != nil {
		return err
	}
...
func (m *CatalogGlossarySuggestRequest) validateProperties(formats strfmt.Registry) error {
...
func (m *CatalogGlossarySuggestRequest) validateSummary(formats strfmt.Registry) error {
...
func (m *CatalogGlossarySuggestRequest) validateTitle(formats strfmt.Registry) error {
...
// ContextValidate validate this catalog glossary suggest request based on the context it is used
func (m *CatalogGlossarySuggestRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CatalogGlossarySuggestRequest) contextValidateProperties(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CatalogGlossarySuggestRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CatalogGlossarySuggestRequest) UnmarshalBinary(b []byte) error {
	var res CatalogGlossarySuggestRequest
