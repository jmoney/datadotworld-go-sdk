...
// InsightCreateRequest insight create request
//
// swagger:model InsightCreateRequest
...
// Validate validates this insight create request
func (m *InsightCreateRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InsightCreateRequest) validateBody(formats strfmt.Registry) error {
...
func (m *InsightCreateRequest) validateDataSourceLinks(formats strfmt.Registry) error {
...
func (m *InsightCreateRequest) validateDescription(formats strfmt.Registry) error {
...
func (m *InsightCreateRequest) validateSourceLink(formats strfmt.Registry) error {
...
func (m *InsightCreateRequest) validateThumbnail(formats strfmt.Registry) error {
...
func (m *InsightCreateRequest) validateTitle(formats strfmt.Registry) error {
...
// ContextValidate validate this insight create request based on the context it is used
func (m *InsightCreateRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *InsightCreateRequest) contextValidateBody(ctx context.Context, formats strfmt.Registry) error {
...
func (m *InsightCreateRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *InsightCreateRequest) UnmarshalBinary(b []byte) error {
	var res InsightCreateRequest
