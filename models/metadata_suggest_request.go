...
// MetadataSuggestRequest metadata suggest request
//
// swagger:model MetadataSuggestRequest
...
// Validate validates this metadata suggest request
func (m *MetadataSuggestRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *MetadataSuggestRequest) validateDescription(formats strfmt.Registry) error {
...
func (m *MetadataSuggestRequest) validateMessage(formats strfmt.Registry) error {
...
func (m *MetadataSuggestRequest) validateProperties(formats strfmt.Registry) error {
...
func (m *MetadataSuggestRequest) validateTitle(formats strfmt.Registry) error {
...
// ContextValidate validate this metadata suggest request based on the context it is used
func (m *MetadataSuggestRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *MetadataSuggestRequest) contextValidateProperties(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MetadataSuggestRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *MetadataSuggestRequest) UnmarshalBinary(b []byte) error {
	var res MetadataSuggestRequest
