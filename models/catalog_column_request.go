...
// CatalogColumnRequest catalog column request
//
// swagger:model CatalogColumnRequest
type CatalogColumnRequest struct {
...
// Validate validates this catalog column request
func (m *CatalogColumnRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CatalogColumnRequest) validateDescription(formats strfmt.Registry) error {
...
func (m *CatalogColumnRequest) validateProperties(formats strfmt.Registry) error {
...
func (m *CatalogColumnRequest) validateTitle(formats strfmt.Registry) error {
...
// ContextValidate validate this catalog column request based on the context it is used
func (m *CatalogColumnRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *CatalogColumnRequest) contextValidateProperties(ctx context.Context, formats strfmt.Registry) error {
...
func (m *CatalogColumnRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *CatalogColumnRequest) UnmarshalBinary(b []byte) error {
	var res CatalogColumnRequest
