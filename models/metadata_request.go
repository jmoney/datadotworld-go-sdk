...
// Validate validates this metadata request
func (m *MetadataRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *MetadataRequest) validateDescription(formats strfmt.Registry) error {
...
func (m *MetadataRequest) validateProperties(formats strfmt.Registry) error {
...
func (m *MetadataRequest) validateTitle(formats strfmt.Registry) error {
...
// ContextValidate validate this metadata request based on the context it is used
func (m *MetadataRequest) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *MetadataRequest) contextValidateProperties(ctx context.Context, formats strfmt.Registry) error {
...
func (m *MetadataRequest) UnmarshalBinary(b []byte) error {
	var res MetadataRequest
